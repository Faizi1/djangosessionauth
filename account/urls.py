...
from account.views import (ActivateView, ActivationConfirm, ChangePasswordView,
                           CheckAuthenticatedView, DeleteAccountView,
                           GetCSRFToken, LoginView, LogoutView,
                           RegistrationView, ResetPasswordConfirmView,
                           ResetPasswordEmailView, ResetPasswordView,
                           UserDetailView)
...
urlpatterns = [
    ...
    path(
        "account/change_password/", ChangePasswordView.as_view(), name="change_password"
    ),
    ...
    path(
        "account/reset_password/<str:uid>/<str:token>/",
