...
SECRET_KEY = 'django-insecure-(re9$yh^d6vm46)2kja6v8e-!g(3$i(jd018y4h!!))kmhj#rq'
...
# If usiing Reactjs VueJs NextJs NuxtJs then you can replace with frontend domain
